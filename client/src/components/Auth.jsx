      ...
      <div className="wrapper">
          ...
          <div className="form-box register animation">
            ...
            <form onSubmit={handleSignupSubmit}>
                    ...
                    <div className="logreg-link animation" style={{ '--i': 22, '--j': 5 }}>
                        <p onClick={switchMode}>Already have an account? <a href="#" className="login-link">Login</a></p>
                    </div>
                    </form>
          </div>
        )}
        <div className="info-text register">
          <h1 className="animation" style={{ '--i': 17, '--j': 0 }}>
            Welcome to Gear! 
          </h1><img src={spinningGear} className="gear-spinning animation" style={{ '--i': 17, '--j': 0 }} width="50" height="50" alt="sign in" />
